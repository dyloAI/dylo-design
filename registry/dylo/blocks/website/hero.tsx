  ...
  return (
    <section className="bg-bone grid-paper px-8 pt-24 pb-[84px]">
      <div className="mx-auto flex max-w-[1180px] flex-col items-start gap-6">
        ...
        <h1 className="text-display m-0 font-bold">Software, made.</h1>
        <p className="text-graphite m-0 max-w-[620px] text-[20px]/[1.55]">
          Apps and data solutions for SMBs that want a dílo — a crafted work — not a robota. We ship production
          software with an AI-native team, fast.
        </p>
